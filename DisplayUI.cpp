...
int length_song;//这里定义一个变量，后面用来表示共有多少个音符
...
void DisplayUI::setup() {
    ...
    createMenu(&mainMenu, NULL, [this]() {
        ...
        addMenuNode(&mainMenu, D_123, [this]() { // PACKET MONITOR
...
void DisplayUI::drawIntro() {
    ...
    display.drawString(64, 20, String(F("Echosafe-Team")));
    display.drawString(64, 34, settings.getVersion());
    display.drawString(64, 48, "IP:192.168.4.1");
    // ====================== //
}
